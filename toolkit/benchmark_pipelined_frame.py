...
def main():
    ...
    report=dict(scope=__doc__,baseline_commit='6dbb142' if args.attribute_flags else 'a4a3f82' if args.attribute_groups else '4b62e52' if args.unrolled_cache else '0e8acec' if args.unrolled_copy else 'a50aa55' if args.packet_ahead else '1f58971',complete=False,release=False,
