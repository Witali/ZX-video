...
def main():
    ...
    h=Harness(bytes(ring),tables,mapping,target,bulk=True,zero_copy=True,stored_guards=False,
        ...
        attribute_flags=args.attribute_flags,gray_cells=args.gray_cells)
    ...
    report=dict(scope=__doc__,baseline_commit='dcfb953' if args.gray_cells else '6dbb142' if args.attribute_flags else 'a4a3f82' if args.attribute_groups else '4b62e52' if args.unrolled_cache else '0e8acec' if args.unrolled_copy else 'a50aa55' if args.packet_ahead else '1f58971',complete=False,release=False,
